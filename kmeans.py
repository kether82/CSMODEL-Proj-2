...
class KMeans(object):
    ...
    def initialize_centroids(self, data):
        ...
        for i in range(1, self.k):
            ...
            #     distances = distances.append(KMeans.get_euclidean_distance(self,sliced_data,self.centroids.iloc[j]), ignore_index=True)
            # print("Dist:")
            # print (distances)
            # print("---")
            ...
            # print("idx")
            # print(distances.min(axis=1).idxmax())
            # print("---")
    ...
    def get_euclidean_distance(self, point1, point2):
        ...
        if(type(point1) is pd.Series):
            return np.sqrt(((point2 - point1)**(2)).sum());
        else:
            return np.sqrt(((point2 - point1)**(2)).sum(axis=1));
